...
A continuación recordamos las nociones básicas sobre tiempo de cómputo, funciones tiempo-construibles y clases de complejidad exponencial, esenciales para analizar el problema $EQ_{REX^\uparrow}$.
...
\end{definition}
El teorema de jerarquía temporal (Definición~\ref{def:tiempo-construible}:) establece que, bajo condiciones razonables, 
